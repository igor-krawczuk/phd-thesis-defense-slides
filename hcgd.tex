...
\begin{frame}[c,label=hcgd]
  ...
  \only<3>{\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{./images/chgd_latency_sum2024-02-25_23-50.png}}
  \only<4>{\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{./images/chgd_latency_avg2024-02-25_23-51.png}}
\end{frame}
